<?php
  ...
  if (!empty($_POST)) {
    $user1->delete(Input::get('id_user'));
    $akun->delete(Input::get('id_akun'));
    $message = urlencode("User dengan nama <b>{$user1->getItem('nama')} sudah berhasil dihapus");
...
<div class="modal-body">
                <p> Apakah Anda yakin menghapus user 
                  <b style=" color:#009d63;"><?php echo $user1->getItem('nama'); ?></b>?</b></p>
              </div>
              ...
              <form method="post">
                <input type="hidden" name="id"
                  value="<?php echo $user1->getItem('id_user'); ?>">
